...
1. 15 simulated bam files (5 trios) from the software `capsim`
      ...
      + 1 true de novo deletion at X in family X1
      + 1 inherited deletion at Y in family Y1
2. A pedigree file 
